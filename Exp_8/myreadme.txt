...
--ckpt experiment/experiment_VAE_test_1/stage2/checkpoints/0030000.pt \
--ckpt_vae experiment/experiment_VAE_test_2/stage2/checkpoints/0030000_vae.pt \
--captioner none \
--cfg_scale 4.0 \
--noise_aug 0 \
--input datasets/ZZCX_2_1/test/LQ \
--condition_path datasets/ZZCX_2_1/test/RGB_HQ_condition \
--output results/3.20_vae_inference/vae_test_4  \
--precision fp32 \
--sampler spaced \
--steps 50 \
--pos_prompt '' \
